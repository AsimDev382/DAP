...
<div class="main-content">
    <!-- Form -->
    <form id="mainForm" action="{{ route('completed.destruction.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf
        ...
        <div class="row px-4">
            ...
            <div class="col-md-12">
                <div class="row d-flex align-items-baseline">
                    @php
                        $latestUser = \App\Models\CompletedDestruction::orderBy('id', 'desc')->first();
            ...
            <div class="mt-3">
                ...
                <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3">{{ old('location') }}</textarea>
            </div>
