...
<div class="main-content">
    <form id="mainForm" action="{{ route('company.update',$company->id ) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row px-4">
            <div class="col-12 mb-4 ">
                <!-- Title -->
                <div class="fw-bold fs-4 me-3">Edit Company</div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div>
                            ...
                            <input type="text" name="company_name" value="{{ $company->company_name }}" class="form-control" id="name" placeholder="HPDC">
                            @error('company_name')
                        ...
                        <div class="my-3">
                            ...
                            <input type="email" name="company_email" value="{{ $company->company_email }}" class="form-control" id="name" placeholder="Enter email">
                            @error('company_email')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        {{-- <div class="my-3">
                            ...
                            <input type="password" name="password" value="{{ decrypt($company->password) }}" class="form-control" id="password" placeholder="Enter Password">
                        ...
                        <div class="my-3">
                            ...
                            <input type="text" name="mou_start_date" value="{{ $company->mou_start_date }}" class="form-control datepickerdesign" placeholder="Enter MOU Date">
                    ...
                    <div class="col-md-6">
                        <div>
                            ...
                            <input type="text" name="company_address" value="{{ $company->company_address }}" class="form-control" id="name" placeholder="Enter Address">
                        ...
                        <div class="my-3">
                            ...
                            <input type="text" name="phone_no" value="{{ $company->phone_no }}" class="form-control" id="name" placeholder="Enter Phone No">
                            @error('phone_no')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        {{-- <div class="my-3">
                            ...
                            <div class="input-group">
                            <input type="password" name="password_confirmation" value="{{ decrypt($company->password) }}" class="form-control" id="confirmPassword" placeholder="Confirm Password">
                        ...
                        <div class="my-3">
                            ...
                            <input type="text" name="mou_end_date" value="{{ $company->mou_end_date }}" class="form-control datepickerdesign" placeholder="Enter MOU Expire Date">
                            @error('mou_end_date')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <label class="dropzone" id="dropzoneImg">
                                ...
                                <div class="" id="placeholderImg">
                                    @if($company->company_logo)
                                        <img src="{{ asset('storage/'.$company->company_logo) }}" alt="Upload Icon" class="dropzone-icon">
                                    @else
                    ...
                    <div class="col-md-12 mt-3">
                        {{-- <div class="container  d-flex justify-content-center">
                            <label class="dropzone" id="dropzone">
                                <input type="file" name="company_pdf" Expire id="company_pdf" accept="image/*">
                        ...
                        <div class="container d-flex justify-content-center">
                            <label class="dropzone" id="dropzonePdf">
                                ...
                                <div id="placeholderPdf">
                                    ...
                                    <a href="{{ asset('storage/'.$company->company_pdf) }}" target="_blank"><img src="{{ asset('admin/images/pdf.png') }}" width="30px"></a>
                                        {{-- <img src="{{ asset('storage/'.$company->company_pdf) }}" alt="Upload Icon" class="dropzone-icon"> --}}
                                    @else
                                        <img src="{{ asset('admin/images/Icon.svg') }}" alt="Upload Icon" class="dropzone-icon">
                                    @endif
            ...
            <div class="col-md-12">
                <div class="mb-3 mt-3">
                    <label for="userDetail" class="eighteenblack mb-3">Company Detail (optional)</label>
                    <textarea class="form-control" name="company_detail" id="companydetail" rows="Company Details (optional)5" placeholder="Type company details...">{{ $company->company_detail }}</textarea>
                </div>
            </div>
