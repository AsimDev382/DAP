            ...
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-md-2">
                    <div class="text-center">
                        ...
                        <b>{{ $report->user->auto_id }}</b>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="text-center">
                        <h6 class="twelve pt-4">Client ID</h6>
                        <b>{{ $report->client_id }}</b>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="text-center">
                        <h6 class="twelve pt-4">Client Name</h6>
                        <b>{{ $report->client_name }}</b>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="text-center">
                ...
                <div class="col-md-2  d-flex justify-content-end align-items-center">
                    <div> <a href="{{ route('client-report.edit', $report->id) }}" class="btn btn-primary px-4 py-2"> Edit</a></div>
                </div>
            </div>
            <hr>
            <div class="row mt-3">
                    ...
                    <div class="row d-flex justify-content-between">
                        ...
                        <div class="col-md-2">
                            <div>
                                ...
                                <h1 class="fourteen ">{{ $report->total_amount }}</h1>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div>
                                <h6 class="twelve pt-4">Payed Amount</h6>
                                <h1 class="fourteen ">{{ $report->payed_amount }}</h1>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div>
                                <h6 class="twelve pt-4">Balance</h6>
                                <h1 class="fourteen ">{{ $report->balance }}</h1>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div>
