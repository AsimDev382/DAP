...
<div class="main-content">
    ...
    <!-- Form -->
    <form id="mainForm" action="{{ route('client-report.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf
        <div class="row px-4">
            <div class="col-12 mb-4 ">
                <!-- Title -->
                <div class="fw-bold fs-4 me-3">Add Client Report</div>
            </div>
                            ...
                            <div class="col-md-12">
                                <div class="">
                                    ...
                                    <select name="user_id" id="UserId" class="form-select">
                                        ...
                                        <option value="{{ $user->id }}">{{ $user->auto_id }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row d-flex align-items-baseline">
                            <div class="col-md-12">
                                <div class="">
                                    ...
                                    <input type="text" id="UserClientId" value="{{ old('client_id') }}" class="form-control" readonly>
                                    <input type="hidden" name="client_id" value="{{ old('client_id') }}" id="hideUserClientId">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row d-flex align-items-baseline">
                            <div class="col-md-12">
                                <div class="">
                                    ...
                                    <input type="text" id="UserClientName" value="{{ old('client_name') }}" class="form-control" readonly>
                                    <input type="hidden" name="client_name" value="{{ old('client_name') }}" id="hideUserClientName">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" name="total_amount" value="{{ old('total_amount') }}" class="form-control" placeholder="Enter Total Amount">
                    @error('total_amount')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" name="payed_amount" value="{{ old('payed_amount') }}" class="form-control" placeholder="Enter Payed Amount">
                    @error('payed_amount')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" name="balance" value="{{ old('balance') }}" class="form-control" placeholder="Enter Balance">
                    @error('balance')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
