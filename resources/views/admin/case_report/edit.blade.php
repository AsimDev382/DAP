...
<div class="main-content">
    ...
    <!-- Form -->
    <form id="mainForm" action="{{ route('case-report.update', $report->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf
        @method('PUT')
        <div class="row px-4">
            <div class="col-12 mb-4 ">
                <!-- Title -->
                <div class="fw-bold fs-4 me-3">Edit Case Report</div>
            </div>
                ...
                <div class="row d-flex align-items-baseline">
                    <div class="col-md-12">
                        <div class="">
                            ...
                            <input type="text" name="auto_id" class="form-control" value="{{ $report->auto_id }}" readonly id="name">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
             ...
             <div class="col-md-4">
                <div class="">
                    <label class="eighteenblackmb-2">Status*</label>
            ...
            <div class="col-md-12">
                <div class="mb-3 mt-3">
                    ...
                    <textarea name="description" class="form-control" id="summernote" placeholder="Type company details...">{{ $report->description }}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12">
             <div class="row d-flex justify-content-between">
                ...
                <div class="col-md-6 text-end"> <a href="{{ route('case-report.index') }}" class="btn btn-cancel me-2">Cancel</a>
