...
<div class="main-content">
    ...
    <!-- Form -->
    <form id="mainForm" action="{{ route('case-report.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf
        <div class="row px-4">
            <div class="col-12 mb-4 ">
                <!-- Title -->
                <div class="fw-bold fs-4 me-3">Add Case Report</div>
            </div>
            @php
            $latestUser = \App\Models\CaseReport::orderBy('id', 'desc')->first();
            ...
            <div class="col-md-12">
                <div class="mb-3 mt-3">
                    <label for="userDetail" class="eighteenblack mb-2">Destruction Description (optional)</label>
                    <textarea name="description" class="form-control" id="summernote" placeholder="Type company details...">{{ old('description') }}</textarea>
                </div>
            </div>
