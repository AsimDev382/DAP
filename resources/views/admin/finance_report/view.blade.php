...
<div class="main-content">
    ...
    <div class="row px-5">
        <div class="col-md-12">
            <div class="fw-bold fs-4 me-3">Finance Report</div>
        </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-12">
                    <div class="row d-flex justify-content-left">
                        ...
                        <div class="col-md-2">
                            <div>
                                <h6 class="twelve pt-4">Expense</h6>
                                <h1 class="fourteen ">{{ $report->expenses }}</h1>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div>
                                <h6 class="twelve pt-4">Profit</h6>
                                <h1 class="fourteen ">{{ $report->profit }}</h1>
                            </div>
                        </div>
