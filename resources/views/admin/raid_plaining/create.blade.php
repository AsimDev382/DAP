...
<div class="main-content">
    <!-- Form -->
    <form id="mainForm" action="{{ route('raid.plaining.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf

        <div class="row px-4">
            <div class="col-12 mb-4 ">
                <!-- Title -->
                <div class="fw-bold fs-4 me-3">Add Raid Actions</div>
            </div>
            <div class="col-md-10">
                <div class="row d-flex align-items-baseline">
                    @php
                        $latestUser = \App\Models\RaidPlaining::orderBy('id', 'desc')->first();
                    ...
                    <div class="col-md-6">
                        <div class="mt-4">
                            ...
                            <select class="form-select" name="raid_type" aria-label="Default select example">
                                <option disabled selected>Select raid Type</option>
