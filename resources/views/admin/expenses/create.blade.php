...
<div class="main-content">
    ...
    <!-- Form -->
    <form id="mainForm" action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf
        <div class="row px-4">
            <div class="col-12 mb-4 ">
                <!-- Title -->
                <div class="fw-bold fs-4 me-3">Add Expenses</div>
            </div>
            @php
            $latestUser = \App\Models\Expenses::orderBy('id', 'desc')->first();
                ...
                <div class="row d-flex align-items-baseline">
                    ...
                    <div class="col-md-4">
                        <div class="my-3">
                            ...
                            {{-- <input type="text" name="case_name" value="{{ old('case_name') }}" class="form-control" id="name">
                            @error('case_name')
            ...
            <div class="col-md-3">
                <div class="my-3">
                    ...
                    <input type="text" name="case_expense" class="form-control" value="{{ old('case_expense') }}" placeholder="Enter Case Expenses">
                    @error('case_expense')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
